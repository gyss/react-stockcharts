...
function tickHelper(props, scale) {
	...
	var tickValues = isNotDefined(tickValuesProp) ? isDefined(scale.ticks) ? scale.ticks(tickArguments, flexTicks) : scale.domain() : tickValuesProp;
...
function Tick(props) {
	...
	return React.createElement(
		"g",
		{ className: "tick" },
		React.createElement("line", { shapeRendering: "crispEdges", opacity: tickStrokeOpacity, stroke: tickStroke,
			x1: x1, y1: y1,
			x2: x2, y2: y2 }),
		React.createElement(
			"text",
