	...
	_createClass(HoverTooltip, [{
		...
		value: function renderSVG(moreProps) {
			...
			return React.createElement(
				"g",
				null,
				React.createElement("rect", { x: centerX - drawWidth / 2, y: 0, width: drawWidth, height: height, fill: bgFill, opacity: bgOpacity }),
				React.createElement(
					"g",
...
HoverTooltip.propTypes = {
	...
	tooltipContent: PropTypes.oneOfType([PropTypes.object, PropTypes.func]).isRequired,
...
function backgroundShapeSVG(_ref) {
	...
	return React.createElement("rect", { height: bgheight, width: bgwidth, fill: fill, opacity: opacity, stroke: stroke });
}
